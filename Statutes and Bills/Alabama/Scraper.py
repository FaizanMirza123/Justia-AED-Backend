...
OUTPUT_FILE = 'alabama_statutes_final.jsonl'
...
async def scrape_alabama():
    ...
    try:
        for kw in SEARCH_KEYWORDS:
            ...
            url = f"https://law.justia.com/lawsearch?query=Alabama+{kw}&filter=codes/alabama"
            ...
            for page_num in range(1, 11):
                ...
                if not results:
                    ...
                    results = await page.select_all("a[href*='codes/alabama']")
                    is_direct_link = True
                ...
                for i, res in enumerate(results):
                    try:
                        ...
                        if is_direct_link:
                            ...
                            if "alabama" in href.lower() and ("/codes/" in href or "/regulations/" in href):
                                target_link = href
                            ...
                            for link_el in all_links:
                                ...
                                # Filter: Must be Justia, Must be Alabama, Must be Code/Reg
                        ...
                        if not target_link:
                            # print(f"      [DEBUG] Item {i}: No valid target link extracted")
                            continue
