...
OUTPUT_FILE = 'Delaware_statutes_final.jsonl'
...
async def scrape_alabama():
    ...
    try:
        for kw in SEARCH_KEYWORDS:
            ...
            url = f"https://law.justia.com/lawsearch?query=Delaware+{kw}&filter=codes/delaware"
            ...
            for page_num in range(1, 11):
                ...
                if not results:
                    ...
                    results = await page.select_all("a[href*='codes/delaware']")
                    is_direct_link = True
                ...
                for i, res in enumerate(results):
                    try:
                        ...
                        if is_direct_link:
                            ...
                            if "delaware" in href.lower() and ("/codes/" in href or "/regulations/" in href):
                                target_link = href
                            ...
                            for link_el in all_links:
                                ...
                                if href and ("justia.com" in href or href.startswith("/")):
                                    ...
                                    if "delaware" in href_lower and ("/codes/" in href_lower or "/regulations/" in href_lower or "regulations.justia.com" in href_lower):
                                        target_link = href
