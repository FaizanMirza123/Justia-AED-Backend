...
STATE_CODE = "CA"  # LegiScan uses 2-letter state codes
...
MIN_COMPLETION = 10  # Minimum % completion to include

# Cookies for LegiScan
COOKIES = {
    'cf_clearance': 'I_Zk.FfUQq681aWeR4ROA58IfSiTnMi8u4afWnrDeEk-1770736154-1.2.1.1-KGKZ5mG7HZG_rvxx.9dV5c_tUy39.DcVs0NOhGaJmZzLK8SrBi2YFvI4A0qCK4Ur68w2Maytg6h7X4O21citTKddmMFKwIrQ44Eq6IDlZnzyy4F.dlXMnEovvxz4VVn7gAwqkcSd8HJ2Hfh5MifaeayCnU5eGZwHp.Xk1ElPc07Vy81JNywxv5AEv6cqWys7jGHxAXb2DkbVzFhX35RSQRq0Yj9cwuXI1iWvccC9Qls',
    'has_js': '1',
    'SESS578caa163ede3b428d4fb3082193c4c4': 'mb917jn669atk0sfd75gre3372'
}
